...
const Exercises = () => {
  ...
  const [editingId, setEditingId] = useState(null); // ✅ Store which exercise we're editing
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        ...
        await axios.put(
          `http://localhost:3000/exercise/${editingId}`,
          formData,
          getAuthHeaders()
        );
        ...
        Swal.fire({
          ...
          text: "Your exercise has been updated successfully.",
          timer: 2000,
      ...
      Swal.fire({
        ...
        text:
          ...
          "An error occurred while saving the exercise.",
      });
    }
  };

  // ✅ NEW: Reset modal when opening for add
