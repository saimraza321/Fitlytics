...
const Schedule = () => {
  ...
  const handleAddSchedule = async (e) => {
    ...
    // ✅ NEW: Validate past date
    const today = todayISO();
    if (form.date < today) {
      return Swal.fire({
        icon: "warning",
        title: "Invalid Date",
        text: "Cannot schedule sessions for past dates. Please select today or a future date.",
      });
    }
              ...
              <form onSubmit={handleAddSchedule}>
                <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    {/* ✅ NEW: Added min attribute to prevent past dates in calendar */}
                    <input
                      type="date"
                      name="date"
                      value={form.date}
